...
#ifndef EXAMPLES_VYD_APPS_VYD_ARROW_PROJECTED_VERTEX_MAP_H_
#define EXAMPLES_VYD_APPS_VYD_ARROW_PROJECTED_VERTEX_MAP_H_
...
#endif  // EXAMPLES_VYD_APPS_VYD_ARROW_PROJECTED_VERTEX_MAP_H_
